...
ROIdata <- read.csv("BOLD_Crtx_RHelect_model1.csv")
...
# One sample t-test - Sham Encode, Right hemisphere electrodes - Table SXX
...
### **Stim Conditions - Crtx spheres** - Figure X
```{r message=FALSE, warning=FALSE, paged.print=FALSE}
# Does stimulation impact BOLD activity during encode vs recall stages of the task in the regions underneath and between the electrodes in the right hemisphere?
...
ggsave(p.BA.Crtx,file="Figure_RH_elect.tiff", width = 12, height = 9, dpi = 300, units = "cm", device = "tiff")
p.BA.Crtx
